...
- Detect baby crying from audio streams  
- Classify different sound patterns  
- Trigger alerts when predefined thresholds are exceeded  

This reduces false alarms and enables smarter monitoring compared to traditional baby monitors.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/your-username/smart-baby-monitor.git
