...
from server.vision.sleep_tracker import STATE_OUT, get_sleep_tracker


def get_alert_snapshot(inference_state: dict) -> Dict:
    from server.audio.cry_detector import get_status as cry_status
    from server.audio.sound_meter import get_status as sound_status
